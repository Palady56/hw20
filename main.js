...
userObj.fullName = function () {
  return `${this.firstName} ${this.lastName}`; // or userObj.firstName + ' ' + userObj.lastName;
};
...
console.log('Блок тестов где должно быть везде true:')

// должно быть везде true
